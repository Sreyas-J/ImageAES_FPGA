...
#
# Script generated by Vivado on Sun Oct 27 14:30:01 IST 2024
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../AES_128.gen/sources_1/ip/ila_0_1/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../AES_128.gen/sources_1/ip/ila_0_1/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dell/Desktop/FPGA/VivadoProjects/FPGA_project/AES_128/AES_128.cache/compile_simlib/vcs"
  fi
