...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../AES_128.gen/sources_1/ip/ila_0_1/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../AES_128.gen/sources_1/ip/ila_0_1/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dell/Desktop/FPGA/VivadoProjects/FPGA_project/AES_128/AES_128.cache/compile_simlib/xcelium"
  fi
