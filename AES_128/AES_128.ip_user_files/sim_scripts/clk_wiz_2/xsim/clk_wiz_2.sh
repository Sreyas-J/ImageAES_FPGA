...
#
# Script generated by Vivado on Sun Oct 27 12:57:13 IST 2024
...
# script info
echo -e "clk_wiz_2.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_2 xil_defaultlib.clk_wiz_2 xil_defaultlib.glbl -log elaborate.log
}
