...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../AES_128.gen/sources_1/ip/ila_1_1/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../AES_128.gen/sources_1/ip/ila_1_1/hdl/verilog" \
