...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../AES_nonAccelerated.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../AES_nonAccelerated.gen/sources_1/ip/ila_0/hdl/verilog" \
